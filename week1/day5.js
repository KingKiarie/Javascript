...
let calender =[
    {
        ...
        date: '11-12-2020',
        location: 'lavington',
        attendees: new Set('joe','maria','imram')
    },
    {
        title: 'lesson2',
        date: '11-19-2020',
        location:'lavington',
        attendees: new Set('job','faith','keisha')
    },
    {
        title: 'lesson3',
        date: '11-22-2020',
        location: 'lavington',
        attendees: new Set('ruth','victor','lorah')
    },
    {
        title: 'lesson4',
        date: '11-27-2020',
        location: 'Lavington',
        attendees: new Set('jose','san_paulo','Maria')

    }
]

function addTitle(title,attendees){
    calender.forEach(function(event){
